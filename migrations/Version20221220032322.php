 ...
 */
final class Version20221220032322 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cart_cart (cart_source INT NOT NULL, cart_target INT NOT NULL, INDEX IDX_E446888E510E1D2C (cart_source), INDEX IDX_E446888E48EB4DA3 (cart_target), PRIMARY KEY(cart_source, cart_target)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('ALTER TABLE cart_cart ADD CONSTRAINT FK_E446888E48EB4DA3 FOREIGN KEY (cart_target) REFERENCES cart (id) ON UPDATE NO ACTION ON DELETE CASCADE');
        $this->addSql('ALTER TABLE cart_cart ADD CONSTRAINT FK_E446888E510E1D2C FOREIGN KEY (cart_source) REFERENCES cart (id) ON UPDATE NO ACTION ON DELETE CASCADE');
